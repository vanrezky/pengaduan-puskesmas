           ...
           <div class="row no-gutters align-items-center">
             <div class="col mr-2">
               <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                 Total TPS</div>
               <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $data['tps']; ?></div>
             </div>
             <div class="col-auto">
           ...
           <div class="row no-gutters align-items-center">
             <div class="col mr-2">
               <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                 Total Jenis TPS</div>
               <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $data['jenistps']; ?></div>
             </div>
             <div class="col-auto">
           ...
           <div class="row no-gutters align-items-center">
             <div class="col mr-2">
               <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                 Total Kontak</div>
               <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $data['kontak']; ?></div>
             </div>
             <div class="col-auto">
